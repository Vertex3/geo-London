...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\gseUW\ETL\config\rt\rtStop.xml" htmlbaseurl="" outputurl="..\..\gseUW\ETL\config\rt\rtStop.xml" processortype="saxon8" useresolver="no" profilemode="0"
		...
		<scenario default="no" name="Scenario3" userelativepaths="yes" externalpreview="no" url="" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
